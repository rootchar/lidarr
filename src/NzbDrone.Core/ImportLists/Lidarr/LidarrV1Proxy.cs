...
namespace NzbDrone.Core.ImportLists.Lidarr
{
    ...
    {
        List<LidarrAuthor> GetAuthors(LidarrSettings settings);
        List<LidarrBook> GetBooks(LidarrSettings settings);
    ...
    public class LidarrV1Proxy : ILidarrV1Proxy
    {
        ...
        public List<LidarrAuthor> GetAuthors(LidarrSettings settings)
        {
            return Execute<LidarrAuthor>("/api/v1/author", settings);
        }

        public List<LidarrBook> GetBooks(LidarrSettings settings)
        {
            return Execute<LidarrBook>("/api/v1/book", settings);
        }
