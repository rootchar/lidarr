...
namespace NzbDrone.Core.Download.Clients.Deluge
{
    ...
    public class DelugeSettings : IProviderConfig
    {
        ...
        [FieldDefinition(5, Label = "Category", Type = FieldType.Textbox, HelpText = "Adding a category specific to Lidarr avoids conflicts with unrelated non-Lidarr downloads. Using a category is optional, but strongly recommended.")]
