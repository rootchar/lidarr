...
namespace NzbDrone.Core.Download.Clients.UTorrent
{
    ...
    public class UTorrentSettings : IProviderConfig
    {
        ...
        [FieldDefinition(7, Label = "Post-Import Category", Type = FieldType.Textbox, Advanced = true, HelpText = "Category for Lidarr to set after it has imported the download. Lidarr will not remove the torrent if seeding has finished. Leave blank to keep same category.")]
